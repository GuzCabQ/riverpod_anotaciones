...
import 'package:riverpod_annotations/presentation/providers/providers.dart';
...
class _TodoView extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final fileteredTodos = ref.watch(filteredTodosProvider);
    return Column(
      children: [
        const ListTile(
        ...
        Expanded(
          child: ListView.builder(
            itemCount: fileteredTodos.length,
            itemBuilder: (context, index) {
              final todo = fileteredTodos[index];
